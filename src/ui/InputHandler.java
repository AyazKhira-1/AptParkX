...
public final class InputHandler {
    ...
    public static String getValidPhoneNumberInput(String prompt) {
        // This calls the main method with a null oldValue, telling it this is for a new entry.
    ...
    public static String getValidPhoneNumberInput(String prompt, String oldValue) {
        ...
        while (true) {
            ...
            if (oldValue != null && newNumber.isEmpty()) {
                return oldValue; // User is editing and chose to keep the old number.
            }
            ...
            // If the new number is the same as the old one, it's valid. No need to check DB.
            ...
            return newNumber; // All checks passed.
        }
    }
