...
The system is designed with a clean, multi-layered architecture to ensure maintainability, scalability, and a clear separation of concerns.
...
- **Architecture:** Multi-Layered
    ...
    - **Service Layer:** Contains the core business logic and orchestrates operations (`ResidentService`, `VehicleService`, `ParkingService`).
    ...
    - **Database Manager:** A singleton class to provide a centralized database connection point.
