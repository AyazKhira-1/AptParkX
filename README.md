...
Create a new database named vehicle_parking_manager.

Import the vehicle_parking_manager.sql file provided in the repository to set up all the necessary tables, data, and triggers.
...
Add the MySQL Connector/J JAR file to your project's libraries/dependencies.
...
Navigate to src/database/DatabaseManager.java and, if necessary, update the DB_USER and DB_PASSWORD constants to match your MySQL credentials.

3. Running the Application
Locate the src/main/AptParkX.java file.

Run the main method from within your IDE.
